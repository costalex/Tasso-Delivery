...
function initializeAutocomplete() {
  var autocomplete = new google.maps.places.Autocomplete(document.getElementById('registration_address'), {componentRestrictions: {country: 'FR'}});
  setAreaLimit(autocomplete);
  google.maps.event.addListener(autocomplete, 'place_changed', function () {
    onPlaceChanged(autocomplete, "registration_address");
  });
}
