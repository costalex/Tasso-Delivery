function display_responsive_notif(courses, nb_course, count) {
  if (nb_course == 0 && count == 0) {
    ...
    text_no_current_course.setAttribute('style', 'font-size: 14px; padding-top: 10px; border-bottom: 1px solid #D8D8D8;');

    var text = document.createTextNode('Pas de courses en cours.');
    text_no_current_course.appendChild(text);
    document.getElementById('responsive_courses_block').appendChild(text_no_current_course);
  }
    ...
    for (i = 0; i < nb_course; i++) {
      ...
      if (i == nb_course - 1) {
        current_course.setAttribute('style', 'margin-bottom: 5px;');
      }
      current_course.setAttribute('id', 'responsive_course_' + (i + 1));
      current_course.setAttribute('class', 'col-xs-12 col-md-12 no_padding_div notif_current_course separator_notif');
      document.getElementById('responsive_courses_block').appendChild(current_course);

      var responsive_block1 = document.createElement('div');
      responsive_block1.setAttribute('id', 'responsive_course_' + (i + 1) + '_block1');
      responsive_block1.setAttribute('align', 'left');
      responsive_block1.setAttribute('class', 'col-xs-12 col-md-12 no_padding_div');
      responsive_block1.setAttribute('style', 'padding-left: 10px; padding-bottom: 5px;');
      document.getElementById('responsive_course_' + (i + 1)).appendChild(responsive_block1);
      ...
      document.getElementById('responsive_course_' + (i + 1) + '_block1').appendChild(input_info);

      var responsive_block2 = document.createElement('div'); // contient la div des step
      responsive_block2.setAttribute('id', 'responsive_course_' + (i + 1) + '_block2');
      responsive_block2.setAttribute('class', 'col-xs-12 col-md-12 no_padding_div');
      document.getElementById('responsive_course_' + (i + 1)).appendChild(responsive_block2);

      var div_step1 = document.createElement('div');
      div_step1.setAttribute('id', 'responsive_course_' + (i + 1) + '_step1');
      div_step1.setAttribute('class', 'col-xs-2 col-md-2 no_padding_div');
      document.getElementById('responsive_course_' + (i + 1) + '_block2').appendChild(div_step1);

      var div_step2 = document.createElement('div');
      div_step2.setAttribute('id', 'responsive_course_' + (i + 1) + '_step2');
      div_step2.setAttribute('class', 'col-xs-2 col-md-2 no_padding_div');
      document.getElementById('responsive_course_' + (i + 1) + '_block2').appendChild(div_step2);

      var div_step3 = document.createElement('div');
      div_step3.setAttribute('id', 'responsive_course_' + (i + 1) + '_step3');
      div_step3.setAttribute('class', 'col-xs-2 col-md-2 no_padding_div');
      document.getElementById('responsive_course_' + (i + 1) + '_block2').appendChild(div_step3);

      var div_step4 = document.createElement('div');
      div_step4.setAttribute('id', 'responsive_course_' + (i + 1) + '_step4');
      div_step4.setAttribute('class', 'col-xs-2 col-md-2 no_padding_div');
      document.getElementById('responsive_course_' + (i + 1) + '_block2').appendChild(div_step4);
      ...
      document.getElementById('responsive_course_' + (i + 1) + '_step1').appendChild(step1);
      ...
      document.getElementById('responsive_course_' + (i + 1) + '_step2').appendChild(step2);
      ...
      document.getElementById('responsive_course_' + (i + 1) + '_step3').appendChild(step3);
      ...
      document.getElementById('responsive_course_' + (i + 1) + '_step4').appendChild(step4);
      ...
      var responsive_block3 = document.createElement('div'); // contient la div avec le bouton
      responsive_block3.setAttribute('id', 'responsive_course_' + (i + 1) + '_block3');
      responsive_block3.setAttribute('class', 'col-xs-3 col-md-3 no_padding_div');
      responsive_block3.setAttribute('align', 'right');
      document.getElementById('responsive_course_' + (i + 1) + '_block2').appendChild(responsive_block3);

      var link_see_course = document.createElement('a'); // entoure le bouton
      link_see_course.setAttribute('id', 'responsive_course_' + (i + 1) + '_link_see_course');
      link_see_course.setAttribute('class', 'hidden_link');
      link_see_course.setAttribute('href', '/trackorder/'+ courses[i].refcourse);
      document.getElementById('responsive_course_' + (i + 1) + '_block3').appendChild(link_see_course);

      var btn_see_course = document.createElement('input'); // bouton permettant d'acceder au tracking de la course
      btn_see_course.setAttribute('id', 'responsive_course_' + (i + 1) + '_btn_see_course');
      ...
      document.getElementById('responsive_course_' + (i + 1) + '_link_see_course').appendChild(btn_see_course);
    }
  }
  else {
